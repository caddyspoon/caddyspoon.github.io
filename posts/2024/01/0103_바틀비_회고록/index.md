...
{{< figure src="MD_imgs/02.webp" caption="하지만 그렇다면 자바스크립트는 대단한 게 아닐까...!" >}}
...
{{< figure src="MD_imgs/02_meme.jpg" title="배포 = 새로운 재해를 맞이하러 갑니다" >}}
...
{{< figure width=700 src="MD_imgs/03_meme.jpg" width=500 caption="그리고 제게 남은 미래">}}
